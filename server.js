...
app.post('/gerar-pdf', (req, res) => {
  ...
  doc.fontSize(14).font('Helvetica').text('oportunidade que foi autuado pelo suposto cometimento da infração prevista no Art. 203, V do Código de Trânsito Brasileiro.', { align: 'left' });
  doc.moveDown();
  ...
  doc.fontSize(14).font('Helvetica').text('A título de exemplo verifica-se que o art. 203, V do CTB, com base na observância do MBFT, prevê no campo “Quando Autuar” a possibilidade de imputação de penalidade em várias possibilidades, ou seja, prevendo condutar distintas.',{ align: 'left' });
  doc.moveDown()
